...
export default function OnboardingPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            alert(`Account created successfully! Your Seller ID: ${sellerId}`);
    ...
    const renderStep = () => {
        switch (step) {
            ...
            case 3: return <StepProfile data={formData} updateData={updateData} />;
            case 4: return <StepLocation data={formData} updateData={updateData} />;
            default: return null;
        }
    };
